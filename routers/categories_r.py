...
@router.get("/get/all")
def get_category_endp(session: SessionDep) -> List[CategoryOut]:
...
def create_category_endp(
    category: CategoryCreate, session: SessionDep, admin: RequireEditorOrHigher
):
...
def update_category_endp(
    category_id: int, category: CategoryCreate, session: SessionDep, admin: RequireEditorOrHigher
):
...
def delete_category_endp(category_id: int, session: SessionDep, admin: RequireAdminOrHigher):
